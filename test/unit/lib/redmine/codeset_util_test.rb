...
class Janya::CodesetUtilTest < ActiveSupport::TestCase
  ...
  def test_to_utf8_by_setting_from_latin1
    with_settings :repositories_encodings => 'UTF-8,ISO-8859-1' do
      ...
      assert_equal s1, Janya::CodesetUtil.to_utf8_by_setting(s2)
      assert_equal s1, Janya::CodesetUtil.to_utf8_by_setting(s3)
    end
  end
  ...
  def test_to_utf8_by_setting_blank_string
    assert_equal "",  Janya::CodesetUtil.to_utf8_by_setting("")
    assert_equal nil, Janya::CodesetUtil.to_utf8_by_setting(nil)
  end

  def test_to_utf8_by_setting_returns_ascii_as_utf8
    s1 = "ASCII".force_encoding("UTF-8")
    s2 = s1.dup.force_encoding("ISO-8859-1")
    str1 = Janya::CodesetUtil.to_utf8_by_setting(s1)
    str2 = Janya::CodesetUtil.to_utf8_by_setting(s2)
  ...
  def test_to_utf8_by_setting_invalid_utf8_sequences_should_be_stripped
    with_settings :repositories_encodings => '' do
      ...
      str = Janya::CodesetUtil.to_utf8_by_setting(s1)
